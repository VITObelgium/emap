                    ...
                    try {
                        ...
                        if (isCoursestGrid) {
                            if (spatPatInfo.status == SpatialPatternProcessInfo::Status::FallbackToUniformSpread) {
                                summary.add_spatial_pattern_source_without_data(spatialPattern.source, spatPatInfo.totalEmissions, spatPatInfo.emissionsWithinOutput, emission->point_emission_sum(), emission->diffuse_scaling_factor(), emission->point_scaling_factor());
                            } else {
                                summary.add_spatial_pattern_source(spatialPattern.source, spatPatInfo.totalEmissions, spatPatInfo.emissionsWithinOutput, emission->point_emission_sum(), emission->diffuse_scaling_factor(), emission->point_scaling_factor());
                            }
                        }
