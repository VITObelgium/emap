...
static const std::array<GridData, enum_count<GridDefinition>()> s_gridData{{
    ...
    {GridDefinition::Emap1, "EMAP 1", GeoMetadata(46, 67, -10.75, 34.75, {0.5, -0.5}, nan, s_epsg4326)},
    {GridDefinition::Emap3tf, "EMAP 3TF", GeoMetadata(62, 111, -1.05, 47.35, {0.1, -0.1}, nan, s_epsg4326)},
    {GridDefinition::Emap5tf, "EMAP 5TF", GeoMetadata(108, 207, 1.35, 48.825, {0.025, -0.025}, nan, s_epsg4326)},
