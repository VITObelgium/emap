...
const NfrSector Nfr1A3bviii("1A3bviii", NfrId(7021), gnfr::RoadTransport, "Road transport: Resuspension", EmissionDestination::Land);

const NfrSector Nfr1A3c("1A3c", NfrId(7022), gnfr::Offroad, "Railways", EmissionDestination::Land);

const NfrSector Nfr1A3di_i("1A3di(i)", NfrId(7023), gnfr::Shipping, "International maritime navigation", EmissionDestination::Sea);
const NfrSector Nfr1A3di_ii("1A3di(ii)", NfrId(7024), gnfr::Shipping, "International inland waterways", EmissionDestination::Land);
const NfrSector Nfr1A3dii("1A3dii", NfrId(7025), gnfr::Shipping, "National navigation (shipping)", EmissionDestination::Land);
...
const NfrSector Nfr1A4bi("1A4bi", NfrId(7030), gnfr::Offroad, "Residential: Stationary", EmissionDestination::Land);
...
const NfrSector Nfr5C1bv("5C1bv", NfrId(7122), gnfr::Waste, "Cremation", EmissionDestination::Land);
const NfrSector Nfr5C2("5C2", NfrId(7124), gnfr::Waste, "Open burning of waste", EmissionDestination::Land);
const NfrSector Nfr5D3("5D3", NfrId(7127), gnfr::Waste, "Other wastewater handling", EmissionDestination::Land);
const NfrSector Nfr5E("5E", NfrId(7128), gnfr::Waste, "Other waste (please specify in the IIR)", EmissionDestination::Land);
